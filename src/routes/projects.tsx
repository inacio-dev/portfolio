...
export default function ProjectsPage() {
  ...
  useEffect(() => {
    console.log(contentSize.height + headerSize.height, height)
    console.log(contentSize.height, headerSize.height)
  }, [contentSize, height, headerSize])

  return (
    <div
      className={clsx(
        'flex w-full items-center justify-center overflow-hidden bg-slate-dark-1',
    ...
    >
      <div
        id="content"
        className="flex flex-col items-center justify-center space-y-5 px-[10%] text-slate-light-1 transition-all"
      >
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center justify-center space-y-3 justify-self-center lg:flex-row lg:space-y-0 lg:space-x-5">
                      ...
                      {proj.link && (
                        <Link
                          className="flex h-12 items-center justify-center rounded-sm px-3 transition-all hover:bg-brand-blue-columbia/20"
                          to={`/${i18n.language}/projects/${String(proj.id)}`}
                          replace
                        >
                          {project['link-button']}
                        </Link>
